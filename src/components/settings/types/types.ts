...
export type SettingsMainTab = 'agents' | 'mcp' | 'skills' | 'appearance' | 'git' | 'api' | 'tasks' | 'notifications' | 'plugins' | 'about';
export type AgentProvider = 'claude' | 'codex';
export type AgentCategory = 'account' | 'permissions' | 'providers';
